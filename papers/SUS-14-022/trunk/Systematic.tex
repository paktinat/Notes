...
\item  The energy scales for electron, muon, and \Tau objects affect the shape of the kinematical distributions.
...
\item The uncertainty in the \Tau identification efficiency is 6\%. 
  ...
  A ``tag-and-probe'' technique on $\cPZ\to \Pgt\Pgt$ data events is used to estimate these 
