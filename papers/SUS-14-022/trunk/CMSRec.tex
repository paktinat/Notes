...
\ptvecmiss and the corrections to the jet energies described above.  The missing transverse momentum in the event (\MPT) is defined as the magnitude of \ptvecmiss.
...
For the signal MC samples, a pair of charginos (\chione) 
