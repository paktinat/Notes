...
Jets are reconstructed from the particle-flow objects with the anti-\kt clustering
...
Events from SM processes that may represent signficant sources of backgrounds, $\cPZ$+jets, \wjets, $\cPqt\cPaqt$, and di-boson 
...
are produced and decay exclusively to the final states that contain two taus, two tau neutrinos, and %$\tau$, two $\nu_{\tau}$ and 
