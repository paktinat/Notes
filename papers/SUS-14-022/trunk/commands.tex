...
\newcommand{\Tau}{\ensuremath{\tau_{\rm h}}\xspace}
...
\newcommand{\eTau}{\ensuremath{\,{\rm e}\Tau}\xspace}
...
\newcommand{\genMET}{\ensuremath{{p}_\mathrm{T}^\mathrm{gen}\hspace{-1.75em}/\kern 0.5em}\xspace\xspace\xspace}
