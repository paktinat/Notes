...
\abstract{
A search for electroweak production of supersymmetric particles is performed with two tau leptons in the final state. These results are based on 18.1 to $19.6~\mathrm{fb}^{-1}$ of proton-proton collisions at $\sqrt{s} = 8~\mathrm{TeV}$, collected with the CMS detector at the LHC. The observed events are found to be consistent with the standard model prediction. Upper limits are set on the masses of the lightest chargino and the lightest neutralino, assuming the third generation sleptons are the lightest sleptons and their masses are midway between the chargino and the neutralino masses. In the context of simplified model spectra, charginos lighter than $421~\mathrm{GeV}$ are excluded at $95\%$ confidence level in the case of a massless neutralino.
}    
