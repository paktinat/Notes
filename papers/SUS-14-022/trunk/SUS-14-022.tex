...
These results are based on data of proton-proton collisions at $\sqrt{s} = 8~\mathrm{TeV}$, collected with the CMS detector at the LHC and corresponding to an integrated luminosity between 18.1 $18.1$ and 19.6 $19.6~\mathrm{fb}^{-1}$. 
