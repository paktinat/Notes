...
and the corresponding identification and isolation requirements are tightened.
...
invariant mass between 15 and 45\GeV or $>$ 75\GeV, \deltaphi $>$ 1.0. We also reject events with b-tagged jets to reduce the 
\ttbar background.
...
\caption{\mttwo  distributions for events in the sample after preselection, compared to SM expectation in (left) e$\tau_{h}$ and (right) \muTau channels. The signal distribution is shown for $m_{\chione}=380\GeV,~m_{\PSGczDo}=1\GeV$.}
