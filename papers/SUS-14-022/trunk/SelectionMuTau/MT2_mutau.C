...
//=========  (Mon Jul 18 15:03:36 2016) by ROOT version5.34/03
   ...
   TPad *muTau_log_comp_overlay_plotpad = new TPad("muTau_log_comp_overlay_plotpad", "Pad containing the overlay plot",0,0.22,1,1);
   muTau_log_comp_overlay_plotpad->Draw();
   muTau_log_comp_overlay_plotpad->cd();
   muTau_log_comp_overlay_plotpad->Range(13.31066,-3.83404,161.9728,5.159975);
   ...
   muTau_log_comp_overlay_plotpad->SetLeftMargin(0.1795302);
   muTau_log_comp_overlay_plotpad->SetRightMargin(0.08053691);
   muTau_log_comp_overlay_plotpad->SetTopMargin(0.06976745);
   muTau_log_comp_overlay_plotpad->SetBottomMargin(0.05) ; //0.1710963);
...
tex->SetNDC();
   ...
   TPad* muTau_log_comp_overlay_ratiopad = new TPad("muTau_log_comp_overlay_ratiopad", "Pad containing the ratio",0,0.0 , 1.0 , 0.2);
   ...
   muTau_log_comp_overlay_ratiopad->SetLeftMargin(0.1795302);
   muTau_log_comp_overlay_ratiopad->SetRightMargin(0.08053691);
   muTau_log_comp_overlay_ratiopad->SetTopMargin(0.08) ; //6976745);
   muTau_log_comp_overlay_ratiopad->SetBottomMargin(0.35 );//1710963);
   ...
   TH1D* hOne = h_stack->GetStack()->Last()->Clone("hOne");
   //hOne->Sumw2();
   TH1D *hMC = h_stack->GetStack()->Last()->Clone("hMC");
   hOne->Divide( hMC );
   hOne->SetMinimum(0);
   hOne->SetMaximum(2);
