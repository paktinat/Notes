...
\ptvecmiss which is shared between the two decay chains. The \ptvecmiss is interpreted as the \pt sum of the transverse momenta
of the neutralinos, $\vec{p}_{\rm T}^{\PSGczDo(i)}$.
In practice, in decay chains with neutrinos, \ptvecmiss also includes contributions from the $\pt$ neutrinos.
