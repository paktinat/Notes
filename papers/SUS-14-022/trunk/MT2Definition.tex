...
%With  our choices of $m_{\PSGczDo}$ and $\mvisi$, the resulting \mttwo value for background 
%processes is close to zero, regardless of the values of \MPT and the \PT of 
%the $\tau$ candidates, for the back-to-back topology of \tauTau or \leptonTau  
%events which are produced in Drell--Yan (DY) or in dijets events if both jets are misidentified as leptons.
