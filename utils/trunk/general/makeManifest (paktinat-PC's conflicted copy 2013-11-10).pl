...
my $VERSION = sprintf "%d.%03d", q$Revision: 188019 $ =~ /(\d+)/g;
my $verbose;
...
#
   ...
   # \RCS$Revision: 188019 $
   # \RCS$Date: 2013-05-30 18:20:00 +0430 (Thu, 30 May 2013) $
   # \RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/utils/trunk/general/makeManifest.pl $
   # \RCS$Id: makeManifest.pl 188019 2013-05-30 13:50:00Z alverson $
