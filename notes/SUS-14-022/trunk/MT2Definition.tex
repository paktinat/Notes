...
or a combination of a muon or an electron with a $\hadtau$ candidate ($\leptonTau$ channel), so $\mvisi$ is the mass of a lepton and can be set to zero. We set also $m_{\PSGczDo}=0$. 
