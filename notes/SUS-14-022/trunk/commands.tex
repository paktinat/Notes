...
\renewcommand{\ptvecmiss}{\ensuremath{\ptvec^{\rm miss}}\xspace}
\renewcommand{\PSGcmDo}{\ensuremath{\widetilde{\chi}_{1}^{-}}\xspace}
\renewcommand{\PSGcpDo}{\ensuremath{\widetilde{\chi}_{1}^{+}}\xspace}
\newcommand{\binone}{bin \uppercase\expandafter{\romannumeral 1}\xspace}
\newcommand{\bintwo}{bin \uppercase\expandafter{\romannumeral 2}\xspace}
