...
\item The uncertainty on the \Tau identification efficiency is 6\% \cite{Khachatryan:2014wca}. 
...
the efficiency of  b-tagged jets veto and a 6\% uncertainty on the \deltaphi requirement. The ISR
...
objects and unclustered energy.  The ``unclustered energy'' is for the energy of the reconstructed objects which
 ...
 Carlo simulation studies \cite{CMS_AN_2012-248, CMS_AN_2014-099}.
