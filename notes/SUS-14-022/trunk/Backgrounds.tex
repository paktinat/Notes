...
This is done in a data sample of same-sign \leptonTau events selected 
...
when the fake rate is evaluated in this sample with the same method as used for data, except the \leptonTau pair are OS. 
This fake rate is in agreement with the fake rate measured in data within the uncertainties.
It correctly predicts the number of \leptonTau background events in this sample, within the 
uncertainties.
