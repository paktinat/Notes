...
{\bf FIXME ratio description, figures, ..}
...
%($I_{\Tau} <$ 2 \GeV ) 
are excluded, but in the control region, only the pairs with at least a loosely isolated \Tau 
...
is found and verfied to be flat as a function of the search variable. 
