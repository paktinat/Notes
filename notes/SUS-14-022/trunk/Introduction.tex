...
Throughout this paper we focus on $\PSGcpDo\PSGcmDo$ production. 
...
collected with the CMS detector at the Large Hadron Collider (LHC) during 2012, corresponding to an integrated
...
in Section 2; the \mttwo variable is introduced in Section \ref{sect:mt2def}; 
