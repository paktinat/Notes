...
for every particle an sparticle is defined which is exactly the same, but differs in spin by 1/2. 
...
new physics with a missing transverse energy (\MET), an R-parity conserving Simplified SUSY model \cite{Alwall:2008ag,alves:sms} is used 
...
accompanied by \MET are considered.
...
of the pair production is 27 $fb$ and 1170 $fb$, respectively. Due to the higher cross section, through this note 
we focus on the $\PSGcpDo\PSGcmDo$ production. 
