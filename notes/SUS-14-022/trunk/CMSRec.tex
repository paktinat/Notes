...
All of the backgrounds like $\cPZ$jets, $\PW$jets, $\cPqt\cPaqt$ and di-boson production are generated using the \MADGRAPH 5.1~\cite{Alwall:2011uj} generator, but single-top-quark events generated by {\POWHEG} 1.0~\cite{Nason:2004rx,Frixione:2007vw,Alioli:2009je,Alioli:2010xd}.
