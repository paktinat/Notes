...
//=========  (Sun Feb  7 15:28:32 2016) by ROOT version5.34/03
   TCanvas *QCDWestimation_bin1 = new TCanvas("QCDWestimation_bin1", "",57,71,600,600);
   gStyle->SetOptFit(1);
...
tex->SetNDC();
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.22,0.8,"#tau_{h}#tau_{h} SR1");
tex->SetNDC();
   tex->SetLineWidth(2);
   tex->Draw();
