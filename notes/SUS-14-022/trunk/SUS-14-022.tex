...
\title{Search for electroweak production of SUSY particles in di-tau final states}
...
\abstract{
 A search for electroweak production of SUSY is performed when two $\tau$'s and invisible particles are 
 ...
 $M_{\rm T2}$ is used as a search variable to distinguish between signal and background. 
 In a special part of the phase space, moderate $M_{\rm T2}$, the sum of the transverse  
 mass of the two $\tau$ leptons was found to be a useful variable. In different bins of the search, 
...
pdftitle={Search for electroweak production of SUSY particles in di-tau final states},%
pdfsubject={CMS},%
