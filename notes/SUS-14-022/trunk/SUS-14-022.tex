...
\title{Search for electroweak production of charginos in di-$\tau$ final states in pp collisions at $\sqrt{s}= 8$ \TeV with the CMS detector}
...
\abstract{
 A search for electroweak production of supersymmetry is performed 
with two  $\tau$ leptons in the final state
%when two $\tau$ leptons and invisible particles are produced in the final state. 
 At least one of the $\tau$ leptons is required to decay hadronically.
 Different channels use 18.1 to 19.6  \fbinv  of proton-proton collisions at $\sqrt{s}$ = 8\,TeV.
% The $M_{\rm T2}$ variable is used as a search variable to distinguish between signal and background. 
% In a special part of the phase space, moderate $M_{\rm T2}$, the sum of the transverse  
% mass of the two $\tau$ leptons is found to be a useful variable. 
Both $M_{\rm T2}$  variable and the sum of the transverse mass of the two $\tau$ leptons
are used as search variables. 
