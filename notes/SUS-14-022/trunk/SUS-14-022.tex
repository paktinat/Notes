...
Both $M_{\rm T2}$  variable and the sum of the transverse mass of the two tau leptons
...
In different signal regions, 
 ...
 In the context of the simplified models, charginos lighter than XXX and neutralino masses below YYYY
