...
% with at least one tau decaying hadronically.
...
%  At least one of the $\tau$ leptons is required to decay hadronically.
 These results are based on 18.1 to 19.6  \invfb  of proton-proton collisions at $\sqrt{s}$ = 8\,TeV
 collected with the CMS detector at the CERN Large Hadron Collider.
%{\bf (These luminosity numbers look strange.  Are we sure?).} They are very close to AN-13-171 (HtoTauTau) numbers
...
No significant excess of events is found with respect to standard model expectations,
and upper limits are set
 on the masses of the lightest chargino and neutralino.
 In the context of simplified models, charginos lighter than 410 \GeV 
 are excluded at 95\% confidence level in the case of zero neutralino mass.
}    
