...
\title{Search for electroweak production of charginos in di-tau final states}
...
\abstract{
 A search for electroweak production of SUSY is performed when two $\tau$ leptons and invisible particles are 
 produced in the final state. At least one of the $\tau$ leptons is required to decay hadronically.
 ...
 mass of the two $\tau$ leptons is found to be a useful variable. In different bins of the search, 
...
pdftitle={Search for electroweak production of charginos in di-tau final states},%
pdfsubject={CMS},%
