...
In all signal regions the observed data  are consistent with the predicted SM values.
...
The uncertainty band in these four plots, includes both the statistical and systematical uncertainties.
...
\end{figure}
\end{linenomath}
shows our results in the \tauTau channel, where the \chione masses are excluded up to 395\GeV for a massless \PSGczDo. 
A stringent limit is obtained with our optimized selection requirements where the SM background events are optimally reduced.
...
The results of the \tauTau channels are interpreted to set limit on the  \sTau\sTau production, 
