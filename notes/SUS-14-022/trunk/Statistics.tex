...
The results of the \tauTau channels are also interpreted to set limit on the  \sTau\sTau production, 
...
The best limit, which corresponds to the lowest signal strength, is obtained for $m_{\sTau}=110\GeV$. The observed (expected) upper limit on the cross section at this mass is 228 (328) fb which is almost two (three) times larger than the theoretical NLO cross section.
