...
are produced and decay exclusively to the shown final states which contain 2 $\tau$, 2 $\nu_{\tau}$ and 2 \PSGczDo.
...
\end{figure}
\end{linenomath}
 no point is excluded and $95\%$ upper limit is set on the cross section. Figure ~\ref{fig:limit_stau_stau} represents the ratio of the obtained upper limit on the cross section and the cross section expected from MSSM vs. the mass of the $\tilde{\tau}$ particle, when \PSGczDo mass is $1 GeV$.
