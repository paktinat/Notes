...
The last bins of the histograms correspond to the two signal regions (\binone and \bintwo). The signal contribution shown for $m_{\chione}=240\GeV,~m_{\PSGczDo}=40\GeV$.}
