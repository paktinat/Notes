    ...
    \begin{tcolorbox}[hbox]
      \begin{varwidth}{0.39\textwidth}
        \center{
          ...
          \color{black} Two SS $\tau_{h}\tau_{h}$, one leg loose non medium isolation\\
          and one leg loose isolation. High $M_{T2}$ or $\Sigma m_T^{\tau_i}$
        }
      \end{varwidth}
    \end{tcolorbox}  
  };
    ...
    \begin{tcolorbox}[hbox]
      \begin{varwidth}{0.39\textwidth}
        \center{
          ...
          \color{black} Two SS $\tau_{h}\tau_{h}$, one leg loose non medium isolation\\
          and one leg loose isolation. Low $M_{T2}$ or $\Sigma m_T^{\tau_i}$
        }
      \end{varwidth}
    \end{tcolorbox}
  };
