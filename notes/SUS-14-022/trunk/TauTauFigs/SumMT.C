...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   tex = new TLatex(120,200,"CMS Preliminary");
   tex->SetLineWidth(2);
   tex->Draw();
   
   TH1F *h_stack__1 = new TH1F("h_stack__1","",4,100,300);
   h_stack__1->SetMinimum(0.006447329);
   h_stack__1->SetMaximum(589.0637);
   h_stack__1->SetDirectory(0);
   h_stack__1->SetStats(0);
   h_stack__1->SetLineWidth(2);
   h_stack__1->GetXaxis()->SetTitle("#Sigma m_{T}^{#tau_{i}}");
