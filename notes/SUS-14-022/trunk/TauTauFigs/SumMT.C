{
//=========Macro generated from canvas: SumMT_SSQCD/
//=========  (Sat Jan 30 16:40:24 2016) by ROOT version5.34/03
   TCanvas *SumMT_SSQCD = new TCanvas("SumMT_SSQCD", "",664,26,600,630);
   gStyle->SetOptFit(1);
   SumMT_SSQCD->Range(51.35135,-3.300269,321.6216,3.227076);
   SumMT_SSQCD->SetFillColor(0);
   SumMT_SSQCD->SetBorderMode(0);
   SumMT_SSQCD->SetBorderSize(2);
   SumMT_SSQCD->SetLogy();
   SumMT_SSQCD->SetLeftMargin(0.18);
   SumMT_SSQCD->SetRightMargin(0.08);
   SumMT_SSQCD->SetTopMargin(0.07);
   SumMT_SSQCD->SetBottomMargin(0.17);
   SumMT_SSQCD->SetFrameLineWidth(3);
   SumMT_SSQCD->SetFrameBorderMode(0);
   SumMT_SSQCD->SetFrameBorderSize(0);
   SumMT_SSQCD->SetFrameLineWidth(3);
   SumMT_SSQCD->SetFrameBorderMode(0);
   SumMT_SSQCD->SetFrameBorderSize(0);
   ...
   TH1F *h_stack_stack_1_stack_1_stack_1 = new TH1F("h_stack_stack_1_stack_1_stack_1","",4,100,300);
   h_stack_stack_1_stack_1_stack_1->SetMinimum(0.006447329);
   h_stack_stack_1_stack_1_stack_1->SetMaximum(589.0637);
   ...
   h_stack_stack_1_stack_1_stack_1->GetXaxis()->SetTitle("#Sigma m_{T}^{#tau_{i}}");
   ...
   TH1D *h__MC = new TH1D("h__MC","",4, xAxis7);
   h__MC->SetBinContent(1,13.16519);
   h__MC->SetBinContent(2,45.79428);
   h__MC->SetBinContent(3,22.00659);
   h__MC->SetBinContent(4,1.946929);
   h__MC->SetBinError(1,3.530603);
   h__MC->SetBinError(2,7.453245);
   h__MC->SetBinError(3,5.785825);
   h__MC->SetBinError(4,0.8736402);
   h__MC->SetBinError(5,0.01060099);
   h__MC->SetEntries(459.8746);
   h__MC->SetStats(0);
   ...
   TH1D *h2_copy = new TH1D("h2_copy","",4, xAxis8);
   ...
   TH1D *h_susy = new TH1D("h_susy","",4, xAxis9);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.1946309,0.8815331,"CMS Preliminary");
tex->SetNDC();
   tex->SetLineWidth(2);
   tex->Draw();
   
   TLegend *leg = new TLegend(0.6493289,0.7543554,0.909396,0.9216028,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
   ...
   entry->SetMarkerSize(1);
   leg->Draw();
      tex = new TLatex(108.9425,119.822,"OS #tau_{h}#tau_{h} SR2");
   tex->SetLineWidth(2);
   tex->Draw();
   SumMT_SSQCD->Modified();
   SumMT_SSQCD->cd();
   SumMT_SSQCD->SetSelected(SumMT_SSQCD);
   SumMT_SSQCD->ToggleToolBar();
}
