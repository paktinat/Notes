...
2.96, 7.28, 1.60 and 5.29, respectively.
DY yields are feed to the package as a Gamma distribution with the corresponding statistical weights for each bin.
Furthermore, 25\% and 28\% systematic uncertainty on DY backgrounds are also considered. These systematic uncertainties are considered uncorrelated.
...
The observed limit excludes the $\chione$ with masses up to 430 \GeV when the $\PSGczDo$ mass is zero.
