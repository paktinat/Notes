...
Backgrounds are taken into account in different categories, including DY which is Monte-Carlo-Driven, Low rate backgrounds (\ttbar, VV, Higgs), Fake and QCD which are data driven.
