...
The best limit which corresponds to the lowest signal strength is obtained for $m_{\sTau}=150 \GeV$. The observed (expected) upper limit on the cross section at this mass is 505 (745) fb which is almost two times larger than the theoretical NLO cross section.
