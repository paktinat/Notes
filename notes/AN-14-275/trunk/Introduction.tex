...
Section \ref{sect:stat}. The main efficiencies of the events slections are summarized in Section \ref{sect:model} and finally Section \ref{sect:conclusion} concludes the note.
