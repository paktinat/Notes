...
//=========  (Tue Mar 10 13:45:01 2015) by ROOT version5.34/03
...
// ------------>Primitives in pad: MT2_ratio_plotpad
   ...
   MT2_stack_1->SetMinimum(0.006563586);
   MT2_stack_1->SetMaximum(451.9142);
   ...
   h2_copy->SetBinContent(1,36.96468);
   h2_copy->SetBinContent(2,23.70762);
   h2_copy->SetBinContent(3,8.627916);
   h2_copy->SetBinContent(4,39.36318);
   h2_copy->SetBinContent(5,18.15487);
   h2_copy->SetBinContent(6,1.27287);
   h2_copy->SetBinError(1,6.266806);
   h2_copy->SetBinError(2,5.378869);
   h2_copy->SetBinError(3,1.872272);
   h2_copy->SetBinError(4,11.25666);
   h2_copy->SetBinError(5,4.949743);
   h2_copy->SetBinError(6,0.8464738);
   h2_copy->SetMinimum(0.05);
   h2_copy->SetMaximum(248.462);
   h2_copy->SetEntries(73.75541);
   h2_copy->SetStats(0);
...
tex->SetNDC();
   ...
   MT2__1->SetMinimum(0.006563586);
   MT2__1->SetMaximum(451.9142);
...
// ------------>Primitives in pad: MT2_ratio_ratiopad
   ...
   h2_copy__2->SetBinContent(1,0.7438698);
   h2_copy__2->SetBinContent(2,0.8111593);
   h2_copy__2->SetBinContent(3,0.7999351);
   h2_copy__2->SetBinContent(4,0.8106794);
   h2_copy__2->SetBinContent(5,0.8459716);
   h2_copy__2->SetBinContent(6,1.248515);
   h2_copy__2->SetBinError(1,0.1739395);
   h2_copy__2->SetBinError(2,0.2589052);
   h2_copy__2->SetBinError(3,0.2432866);
   h2_copy__2->SetBinError(4,0.3264462);
   h2_copy__2->SetBinError(5,0.3130626);
   h2_copy__2->SetBinError(6,1.01539);
   h2_copy__2->SetMinimum(0.4);
   h2_copy__2->SetMaximum(3);
   h2_copy__2->SetEntries(19.87618);
   ...
   h1_copy__3->SetBinError(1,0.2277483);
   h1_copy__3->SetBinError(2,0.3174877);
   h1_copy__3->SetBinError(3,0.3013538);
   h1_copy__3->SetBinError(4,0.4009351);
   h1_copy__3->SetBinError(5,0.3538755);
   h1_copy__3->SetBinError(6,0.6620879);
   h1_copy__3->SetMinimum(0);
   h1_copy__3->SetMaximum(2);
   h1_copy__3->SetEntries(37.19704);
