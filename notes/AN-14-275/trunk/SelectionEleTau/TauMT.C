...
//=========  (Sun Mar 15 19:10:01 2015) by ROOT version6.02/04
   TCanvas *TauMT_ratio_AllSUSYc_ratio_TauMT_MT2Cut = new TCanvas("TauMT_ratio_AllSUSYc_ratio_TauMT_MT2Cut", "",539,152,600,600);
...
// ------------>Primitives in pad: TauMT_ratio_AllSUSY_plotpad_TauMT_MT2Cut
   TPad *TauMT_ratio_AllSUSY_plotpad_TauMT_MT2Cut = new TPad("TauMT_ratio_AllSUSY_plotpad_TauMT_MT2Cut", "Pad containing the overlay plot",0,0,1,1);
   ...
   MT2Cut_TauMT_SUSY_380_18->SetBinContent(3,0.9566879);
   MT2Cut_TauMT_SUSY_380_18->SetBinContent(4,1.270462);
   MT2Cut_TauMT_SUSY_380_18->SetBinContent(5,1.657208);
   MT2Cut_TauMT_SUSY_380_18->SetBinContent(6,0.8008448);
   MT2Cut_TauMT_SUSY_380_18->SetBinContent(7,0.2829359);
   MT2Cut_TauMT_SUSY_380_18->SetBinContent(8,0.05857408);
   MT2Cut_TauMT_SUSY_380_18->SetBinContent(9,0.1152141);
   MT2Cut_TauMT_SUSY_380_18->SetBinContent(10,0.1016515);
   MT2Cut_TauMT_SUSY_380_18->SetBinContent(11,0.4502269);
   MT2Cut_TauMT_SUSY_380_18->SetBinError(3,0.4259026);
   MT2Cut_TauMT_SUSY_380_18->SetBinError(4,0.4538473);
   MT2Cut_TauMT_SUSY_380_18->SetBinError(5,0.6615941);
   MT2Cut_TauMT_SUSY_380_18->SetBinError(6,0.3875732);
   MT2Cut_TauMT_SUSY_380_18->SetBinError(7,0.1266625);
   MT2Cut_TauMT_SUSY_380_18->SetBinError(8,0.05857408);
   MT2Cut_TauMT_SUSY_380_18->SetBinError(9,0.08147013);
   MT2Cut_TauMT_SUSY_380_18->SetBinError(10,0.07237496);
   MT2Cut_TauMT_SUSY_380_18->SetBinError(11,0.3962533);
   MT2Cut_TauMT_SUSY_380_18->SetEntries(62);
...
// ------------>Primitives in pad: TauMT_ratio_AllSUSY_ratiopad_TauMT_MT2Cut
   TPad *TauMT_ratio_AllSUSY_ratiopad_TauMT_MT2Cut = new TPad("TauMT_ratio_AllSUSY_ratiopad_TauMT_MT2Cut", "Pad containing the ratio",0,0., 0 , 0);
