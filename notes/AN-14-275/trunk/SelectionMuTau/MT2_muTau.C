...
// ------------>Primitives in pad: muTau_log_comp_overlay_plotpad
   ...
   h_susy->SetBinContent(1,0.5910295);
   h_susy->SetBinContent(2,0.9563957);
   h_susy->SetBinContent(3,0.8125691);
   h_susy->SetBinContent(4,0.7585727);
   h_susy->SetBinContent(5,1.561406);
   h_susy->SetBinContent(6,0.5830534);
   h_susy->SetBinContent(7,0.6879173);
   h_susy->SetBinContent(8,0.3267546);
   h_susy->SetBinContent(9,0.4941146);
   h_susy->SetBinContent(10,0.3885038);
   h_susy->SetBinContent(11,1.021322);
   h_susy->SetBinError(1,0.189015);
   h_susy->SetBinError(2,0.2393891);
   h_susy->SetBinError(3,0.2186165);
   h_susy->SetBinError(4,0.2151454);
   h_susy->SetBinError(5,0.3138357);
   h_susy->SetBinError(6,0.1850846);
   h_susy->SetBinError(7,0.2060545);
   h_susy->SetBinError(8,0.13789);
   h_susy->SetBinError(9,0.1777933);
   h_susy->SetBinError(10,0.1595402);
   h_susy->SetBinError(11,0.2538187);
   h_susy->SetBinError(12,0.2221326);
