...
//=========  (Thu Mar  5 18:34:12 2015) by ROOT version5.34/03
...
// ------------>Primitives in pad: muTau_log_comp_overlay_ratiopad
   ...
   h1_copy->SetBinError(1,0.03138045);
   h1_copy->SetBinError(2,0.03436025);
   h1_copy->SetBinError(3,0.04766398);
   h1_copy->SetBinError(4,0.08987562);
   h1_copy->SetBinError(5,0.2228531);
   h1_copy->SetBinError(6,0.4729044);
   h1_copy->SetBinError(7,0.5898792);
   h1_copy->SetBinError(8,0.9980007);
   h1_copy->SetBinError(9,0.8848756);
   h1_copy->SetBinError(10,0.9514732);
   h1_copy->SetBinError(11,0.4097324);
   h1_copy->SetMinimum(0);
   h1_copy->SetMaximum(2);
   h1_copy->SetEntries(34.7106);
   h1_copy->SetStats(0);
   ...
   h2_copy__2->SetBinContent(1,1.020845);
   h2_copy__2->SetBinContent(2,0.9876561);
   h2_copy__2->SetBinContent(3,0.9365973);
   h2_copy__2->SetBinContent(4,0.9847705);
   h2_copy__2->SetBinContent(5,1.114253);
   h2_copy__2->SetBinError(1,0.02780033);
   h2_copy__2->SetBinError(2,0.02971638);
   h2_copy__2->SetBinError(3,0.03947213);
   h2_copy__2->SetBinError(4,0.07933238);
   h2_copy__2->SetBinError(5,0.2228041);
   h2_copy__2->SetMinimum(0.4);
   h2_copy__2->SetMaximum(3);
   h2_copy__2->SetEntries(430.1519);
   ...
   h1_copy__3->SetBinError(1,0.03138045);
   h1_copy__3->SetBinError(2,0.03436025);
   h1_copy__3->SetBinError(3,0.04766398);
   h1_copy__3->SetBinError(4,0.08987562);
   h1_copy__3->SetBinError(5,0.2228531);
   h1_copy__3->SetBinError(6,0.4729044);
   h1_copy__3->SetBinError(7,0.5898792);
   h1_copy__3->SetBinError(8,0.9980007);
   h1_copy__3->SetBinError(9,0.8848756);
   h1_copy__3->SetBinError(10,0.9514732);
   h1_copy__3->SetBinError(11,0.4097324);
   h1_copy__3->SetMinimum(0);
   h1_copy__3->SetMaximum(2);
   h1_copy__3->SetEntries(34.7106);
