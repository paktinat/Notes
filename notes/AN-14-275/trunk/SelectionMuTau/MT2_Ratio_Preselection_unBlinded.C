...
//=========  (Sun May 17 11:55:26 2015) by ROOT version5.34/03
...
// ------------>Primitives in pad: muTau_log_comp_overlay_plotpad
   ...
   TH1F *h_stack_stack_1_stack_1 = new TH1F("h_stack_stack_1_stack_1","",11,40,150);
   h_stack_stack_1_stack_1->SetMinimum(0.004999187);
   h_stack_stack_1_stack_1->SetMaximum(44137.22);
   ...
   h2_copy->SetBinError(6,4.358899);
...
tex->SetNDC();
   ...
   TH1F *h_stack__1 = new TH1F("h_stack__1","",11,40,150);
   h_stack__1->SetMinimum(0.004999187);
   h_stack__1->SetMaximum(44137.22);
   ...
   TLegend *leg = new TLegend(0.6744966,0.580772,0.909396,0.920147,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
   ...
   entry->SetMarkerSize(1);
   leg->Draw();
      tex = new TLatex(70.3335,10015.18,"CMS Preliminary");
   tex->SetLineWidth(2);
   tex->Draw();
...
// ------------>Primitives in pad: muTau_log_comp_overlay_ratiopad
   ...
   TH1D *h2_copy__2__1 = new TH1D("h2_copy__2__1","",11, xAxis10);
   h2_copy__2__1->SetBinContent(1,1.020717);
   h2_copy__2__1->SetBinContent(2,0.9875407);
   h2_copy__2__1->SetBinContent(3,0.9364654);
   h2_copy__2__1->SetBinContent(4,0.984455);
   h2_copy__2__1->SetBinContent(5,1.112492);
   h2_copy__2__1->SetBinContent(6,1.356524);
   h2_copy__2__1->SetBinContent(7,0.8047947);
   h2_copy__2__1->SetBinContent(8,3.857599);
   h2_copy__2__1->SetBinContent(9,1.960986);
   h2_copy__2__1->SetBinContent(10,0.5439065);
   h2_copy__2__1->SetBinError(1,0.02779456);
   h2_copy__2__1->SetBinError(2,0.02971064);
   h2_copy__2__1->SetBinError(3,0.03946303);
   h2_copy__2__1->SetBinError(4,0.07929119);
   h2_copy__2__1->SetBinError(5,0.222234);
   h2_copy__2__1->SetBinError(6,0.5486034);
   h2_copy__2__1->SetBinError(7,0.5721959);
   h2_copy__2__1->SetBinError(8,3.292851);
   h2_copy__2__1->SetBinError(9,1.657864);
   h2_copy__2__1->SetBinError(10,0.654869);
   h2_copy__2__1->SetMinimum(0.4);
   h2_copy__2__1->SetMaximum(3);
   h2_copy__2__1->SetEntries(12.51214);
   ...
   TH1D *h1_copy__3__2 = new TH1D("h1_copy__3__2","",11, xAxis11);
   h1_copy__3__2->SetBinContent(1,1);
   h1_copy__3__2->SetBinContent(2,1);
   ...
   h1_copy__3__2->SetBinContent(11,1);
   h1_copy__3__2->SetBinError(1,0.03137654);
   h1_copy__3__2->SetBinError(2,0.03435624);
   h1_copy__3__2->SetBinError(3,0.04765729);
   h1_copy__3__2->SetBinError(4,0.08984689);
   h1_copy__3__2->SetBinError(5,0.2225016);
   h1_copy__3__2->SetBinError(6,0.4710047);
   h1_copy__3__2->SetBinError(7,0.5867954);
   h1_copy__3__2->SetBinError(8,0.9784016);
   h1_copy__3__2->SetBinError(9,0.8733925);
   h1_copy__3__2->SetBinError(10,0.9483043);
   h1_copy__3__2->SetBinError(11,0.3405055);
   h1_copy__3__2->SetMinimum(0);
   h1_copy__3__2->SetMaximum(2);
   h1_copy__3__2->SetEntries(35.97444);
   ...
   h1_copy__3__2->GetXaxis()->SetTitle("MT2");
