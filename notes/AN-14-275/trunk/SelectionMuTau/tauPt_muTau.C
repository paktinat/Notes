...
//=========  (Sun Mar  8 15:24:41 2015) by ROOT version5.34/03
...
// ------------>Primitives in pad: muTau_log_comp_overlay_plotpad
   ...
   h__Higgs->SetBinContent(1,0.3418442);
   h__Higgs->SetBinContent(2,0.4788143);
   h__Higgs->SetBinContent(3,0.3180763);
   h__Higgs->SetBinContent(4,0.1344886);
   h__Higgs->SetBinContent(5,0.1366429);
   h__Higgs->SetBinContent(6,0.04871156);
   h__Higgs->SetBinContent(7,0.005655551);
   h__Higgs->SetBinContent(9,0.008527434);
   h__Higgs->SetBinContent(10,0.007032728);
   h__Higgs->SetBinContent(11,0.009650734);
   h__Higgs->SetBinContent(12,0.008635403);
   h__Higgs->SetBinError(1,0.04642202);
   h__Higgs->SetBinError(2,0.06237975);
   h__Higgs->SetBinError(3,0.04597161);
   h__Higgs->SetBinError(4,0.02862672);
   h__Higgs->SetBinError(5,0.03017349);
   h__Higgs->SetBinError(6,0.01721155);
   h__Higgs->SetBinError(7,0.003819149);
   h__Higgs->SetBinError(9,0.006894859);
   h__Higgs->SetBinError(10,0.007032728);
   h__Higgs->SetBinError(11,0.008118409);
   h__Higgs->SetBinError(12,0.006926076);
   ...
   h_susy->SetBinContent(1,0.5642516);
   h_susy->SetBinContent(2,1.300116);
   h_susy->SetBinContent(3,1.350141);
   h_susy->SetBinContent(4,1.115701);
   h_susy->SetBinContent(5,0.8976247);
   h_susy->SetBinContent(6,0.6465613);
   h_susy->SetBinContent(7,0.4627729);
   h_susy->SetBinContent(8,0.3113813);
   h_susy->SetBinContent(9,0.181753);
   h_susy->SetBinContent(10,0.151688);
   h_susy->SetBinContent(11,0.120185);
   h_susy->SetBinContent(12,0.2782774);
   h_susy->SetBinError(1,0.04316949);
   h_susy->SetBinError(2,0.06577424);
   h_susy->SetBinError(3,0.0674561);
   h_susy->SetBinError(4,0.06079243);
   h_susy->SetBinError(5,0.05474542);
   h_susy->SetBinError(6,0.04692762);
   h_susy->SetBinError(7,0.03942014);
   h_susy->SetBinError(8,0.03235926);
   h_susy->SetBinError(9,0.02492837);
   h_susy->SetBinError(10,0.0227658);
   h_susy->SetBinError(11,0.02009298);
   h_susy->SetBinError(12,0.03078723);
   h_susy->SetBinError(13,0.02732204);
...
tex->SetNDC();
   ...
   TLegend *leg = new TLegend(0.6812081,0.5985171,0.909396,0.920147,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
...
// ------------>Primitives in pad: muTau_log_comp_overlay_ratiopad
   ...
   h1_copy->SetBinError(1,0.02523637);
   h1_copy->SetBinError(2,0.0403738);
   h1_copy->SetBinError(3,0.07586711);
   h1_copy->SetBinError(4,0.1357825);
   h1_copy->SetBinError(5,0.188321);
   h1_copy->SetBinError(6,0.2894955);
   h1_copy->SetBinError(7,0.4077783);
   h1_copy->SetBinError(8,0.5020544);
   h1_copy->SetBinError(9,0.6122271);
   h1_copy->SetBinError(10,0.8278274);
   h1_copy->SetBinError(11,0.8543988);
   h1_copy->SetBinError(12,1.172927);
   h1_copy->SetMinimum(0);
   h1_copy->SetMaximum(2);
   h1_copy->SetEntries(38.60643);
   h1_copy->SetStats(0);
   ...
   h2_copy__2->SetBinContent(1,1.065855);
   h2_copy__2->SetBinContent(2,0.8673703);
   h2_copy__2->SetBinContent(3,0.858423);
   h2_copy__2->SetBinContent(4,0.8050841);
   h2_copy__2->SetBinContent(5,0.7295113);
   h2_copy__2->SetBinContent(6,0.4797294);
   h2_copy__2->SetBinContent(7,0.3973128);
   h2_copy__2->SetBinContent(8,0.8756447);
   h2_copy__2->SetBinContent(9,1.402446);
   h2_copy__2->SetBinContent(10,1.981377);
   h2_copy__2->SetBinContent(11,2.409148);
   h2_copy__2->SetBinContent(12,5.096714);
   h2_copy__2->SetBinError(1,0.02314532);
   h2_copy__2->SetBinError(2,0.03165706);
   h2_copy__2->SetBinError(3,0.05903655);
   h2_copy__2->SetBinError(4,0.09939625);
   h2_copy__2->SetBinError(5,0.1440835);
   h2_copy__2->SetBinError(6,0.1550082);
   h2_copy__2->SetBinError(7,0.2293227);
   h2_copy__2->SetBinError(8,0.5934796);
   h2_copy__2->SetBinError(9,0.872915);
   h2_copy__2->SetBinError(10,1.818823);
   h2_copy__2->SetBinError(11,2.240635);
   h2_copy__2->SetBinError(12,5.150487);
   h2_copy__2->SetMinimum(0.4);
   h2_copy__2->SetMaximum(3);
   h2_copy__2->SetEntries(7.979865);
   ...
   line->SetLineWidth(2);
   line->Draw();
   Double_t xAxis11[13] = {20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260}; 
   ...
   h1_copy__3->SetBinError(1,0.02523637);
   h1_copy__3->SetBinError(2,0.0403738);
   h1_copy__3->SetBinError(3,0.07586711);
   h1_copy__3->SetBinError(4,0.1357825);
   h1_copy__3->SetBinError(5,0.188321);
   h1_copy__3->SetBinError(6,0.2894955);
   h1_copy__3->SetBinError(7,0.4077783);
   h1_copy__3->SetBinError(8,0.5020544);
   h1_copy__3->SetBinError(9,0.6122271);
   h1_copy__3->SetBinError(10,0.8278274);
   h1_copy__3->SetBinError(11,0.8543988);
   h1_copy__3->SetBinError(12,1.172927);
   h1_copy__3->SetMinimum(0);
   h1_copy__3->SetMaximum(2);
   h1_copy__3->SetEntries(38.60643);
