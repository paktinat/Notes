...
the data and MC values, the MC prediction in each of the two search regions is corrected by the ratio of the two values and its uncertainty is also taken into account which is about 70\%. 
...
\bintwo & 2.70 $\pm$ 0.22 (stat.) $\pm$ 0.71 (sys. fit) $\pm$ 0.75(0.67) (sys. shape)\\
\hline\hline 
\end{tabular}
