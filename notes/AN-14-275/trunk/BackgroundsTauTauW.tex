...
the two values, 27\% systematic uncertainty is assigned to the ratio from the MC (sys. shape) 
and is added to other systematic uncertainties of the estimation in quadrature.
...
\hline
\binone & 0.93 $\pm$ 0.13 (stat.) $\pm$ 0.14 (sys. fit) $\pm$ 0.25 (sys. shape)\\
\hline\hline 
\end{tabular}
