...
%In either of the two plots, the fit range excludes the first bin since the other bins are a subset of the first bin and we want to fit some statistically-independent values. 
...
$\mindphifour>$ 1 or Z veto. It can be shown that the used subsamples are statistically independent. In table~\ref{tbl:wbkgCorr} 
\begin{table}[!Hhtb]
\begin{center}
...
\end{center}
\end{table}
the efficiency of each cut is 
measured in different subsamples. The efficiencies in different subsamples are found consistent within the uncertainties, confirming 
that the subsamples are statistically independent. 
The results of the fit are summarized in table~\ref{tbl:fitpars}.
\begin{table}[!Hhtb]
\begin{center}
