\section{Physics Object Definition and Preselection}
\label{sect:objdef}
...
I_{e/ \mu}=\Sigma P_{T}^{charged }(\Delta z <2\,mm)+max(P_{T}^{photon}+P_{T}^{h0 }-\Delta \beta,0),
\end{equation}
\end{linenomath}
...
\subsection{\texorpdfstring{Hadronic $\tau$ decays}{Hadronic tau decays}} 
\label{sec:hadTau}
