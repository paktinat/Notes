...
//=========  (Tue Jun 30 16:41:12 2015) by ROOT version5.34/03
...
// ------------>Primitives in pad: MT2_ratio_plotpad
   ...
   MT2_ratio_plotpad->Range(27.48331,-2.654928,122.6101,3.506189);
   ...
   MT2->SetTitle("");
   MT2->SetMinimum(0.02);
   MT2->SetMaximum(634.6379);
   
   TH1F *MT2_stack_1 = new TH1F("MT2_stack_1","",3,40,115);
   MT2_stack_1->SetMinimum(0.00615243);
   MT2_stack_1->SetMaximum(1206.002);
   ...
   MT2_QCD->SetBinContent(1,79.88728);
   MT2_QCD->SetBinContent(2,1.192788);
   MT2_QCD->SetBinContent(3,0.15);
   MT2_QCD->SetBinError(1,14.69015);
   MT2_QCD->SetBinError(2,1.660521);
   MT2_QCD->SetBinError(3,0.35);
   ...
   h2_copy->SetMaximum(634.6379);
   h2_copy->SetEntries(151);
   h2_copy->SetStats(0);
   ...
   MT2_susy->SetBinContent(1,3.953534);
   MT2_susy->SetBinContent(2,3.810925);
   MT2_susy->SetBinContent(3,3.894387);
   MT2_susy->SetBinError(1,0.2546508);
   MT2_susy->SetBinError(2,0.2507737);
   MT2_susy->SetBinError(3,0.298054);
   MT2_susy->SetBinError(4,0.1584216);
   MT2_susy->SetEntries(763);
   MT2_susy->SetStats(0);
...
tex->SetNDC();
   ...
   TH1F *MT2__1 = new TH1F("MT2__1","",3,40,115);
   MT2__1->SetMinimum(0.00615243);
   MT2__1->SetMaximum(1206.002);
   ...
   TLegend *leg = new TLegend(0.7097315,0.6273529,0.909396,0.920147,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
...
// ------------>Primitives in pad: MT2_ratio_plotpad_1
   MT2_ratio_plotpad_1 = new TPad("MT2_ratio_plotpad_1", "newpad",0.1174497,0.94,0.204698,0.9711111);
...
// ------------>Primitives in pad: MT2_ratio_ratiopad
   ...
   h1_copy->SetBinError(1,0.180394);
   h1_copy->SetBinError(2,0.5417383);
   h1_copy->SetBinError(3,0.5738607);
   h1_copy->SetMinimum(0);
   h1_copy->SetMaximum(2);
   h1_copy->SetEntries(13.73336);
   h1_copy->SetStats(0);
   ...
   h2_copy__2->SetBinContent(1,0.992692);
   h2_copy__2->SetBinContent(2,0.6940895);
   h2_copy__2->SetBinContent(3,1.112881);
   h2_copy__2->SetBinError(1,0.1544506);
   h2_copy__2->SetBinError(2,0.4371884);
   h2_copy__2->SetBinError(3,1.201014);
   h2_copy__2->SetMinimum(0.4);
   h2_copy__2->SetMaximum(3);
   h2_copy__2->SetEntries(4.729095);
   ...
   h1_copy__3->SetBinError(1,0.180394);
   h1_copy__3->SetBinError(2,0.5417383);
   h1_copy__3->SetBinError(3,0.5738607);
   h1_copy__3->SetMinimum(0);
   h1_copy__3->SetMaximum(2);
   h1_copy__3->SetEntries(13.73336);
