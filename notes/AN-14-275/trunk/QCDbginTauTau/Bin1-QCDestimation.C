...
//=========  (Tue Aug 18 17:34:53 2015) by ROOT version5.34/03
...
// ------------>Primitives in pad: MT2_ratio_plotpad
   ...
   MT2_ratio_plotpad->Range(27.48331,-2.645183,122.6101,3.437257);
   ...
   MT2->SetTitle("");
   MT2->SetMinimum(0.02);
   MT2->SetMaximum(551.8286);
   
   TH1F *MT2_stack_1_stack_2_stack_3 = new TH1F("MT2_stack_1_stack_2_stack_3","",3,40,115);
   MT2_stack_1_stack_2_stack_3->SetMinimum(0.006210434);
   MT2_stack_1_stack_2_stack_3->SetMaximum(1041.938);
   MT2_stack_1_stack_2_stack_3->SetDirectory(0);
   MT2_stack_1_stack_2_stack_3->SetStats(0);
   MT2_stack_1_stack_2_stack_3->SetLineWidth(2);
   MT2_stack_1_stack_2_stack_3->GetXaxis()->SetTitle("M_{T2}");
   MT2_stack_1_stack_2_stack_3->GetXaxis()->SetNdivisions(505);
   MT2_stack_1_stack_2_stack_3->GetXaxis()->SetLabelFont(42);
   MT2_stack_1_stack_2_stack_3->GetXaxis()->SetLabelSize(0.05);
   MT2_stack_1_stack_2_stack_3->GetXaxis()->SetTitleSize(0.05);
   MT2_stack_1_stack_2_stack_3->GetXaxis()->SetTitleOffset(1.1);
   MT2_stack_1_stack_2_stack_3->GetXaxis()->SetTitleFont(42);
   MT2_stack_1_stack_2_stack_3->GetYaxis()->SetTitle("Events");
   MT2_stack_1_stack_2_stack_3->GetYaxis()->SetNdivisions(505);
   MT2_stack_1_stack_2_stack_3->GetYaxis()->SetLabelFont(42);
   MT2_stack_1_stack_2_stack_3->GetYaxis()->SetLabelSize(0.05);
   MT2_stack_1_stack_2_stack_3->GetYaxis()->SetTitleSize(0.05);
   MT2_stack_1_stack_2_stack_3->GetYaxis()->SetTitleOffset(1.3);
   MT2_stack_1_stack_2_stack_3->GetYaxis()->SetTitleFont(42);
   MT2_stack_1_stack_2_stack_3->GetZaxis()->SetLabelFont(42);
   MT2_stack_1_stack_2_stack_3->GetZaxis()->SetLabelSize(0.035);
   MT2_stack_1_stack_2_stack_3->GetZaxis()->SetTitleSize(0.035);
   MT2_stack_1_stack_2_stack_3->GetZaxis()->SetTitleFont(42);
   MT2->SetHistogram(MT2_stack_1_stack_2_stack_3);
   
   Double_t xAxis23[4] = {40, 65, 90, 115}; 
   
   TH1D *MT2_Higgs = new TH1D("MT2_Higgs","",3, xAxis23);
   ...
   MT2->Add(MT2_Higgs,"");
   Double_t xAxis24[4] = {40, 65, 90, 115}; 
   
   TH1D *MT2_WW = new TH1D("MT2_WW","",3, xAxis24);
   ...
   MT2->Add(MT2_WW,"");
   Double_t xAxis25[4] = {40, 65, 90, 115}; 
   
   TH1D *MT2_Top = new TH1D("MT2_Top","",3, xAxis25);
   ...
   MT2->Add(MT2_Top,"");
   Double_t xAxis26[4] = {40, 65, 90, 115}; 
   
   TH1D *MT2_ZX = new TH1D("MT2_ZX","",3, xAxis26);
   ...
   MT2->Add(MT2_ZX,"");
   Double_t xAxis27[4] = {40, 65, 90, 115}; 
   
   TH1D *MT2_W = new TH1D("MT2_W","",3, xAxis27);
   MT2_W->SetBinContent(1,29.7661);
   MT2_W->SetBinContent(2,2.164595);
   MT2_W->SetBinError(1,6.302931);
   MT2_W->SetBinError(2,1.110782);
   MT2_W->SetEntries(68);
   MT2_W->SetStats(0);
   ...
   MT2->Add(MT2_W,"");
   Double_t xAxis28[4] = {40, 65, 90, 115}; 
   
   TH1D *MT2_QCD = new TH1D("MT2_QCD","",3, xAxis28);
   ...
   MT2->Add(MT2_QCD,"");
   MT2->Draw("hist");
   Double_t xAxis29[4] = {40, 65, 90, 115}; 
   
   TH1D *h2_copy = new TH1D("h2_copy","",3, xAxis29);
   ...
   h2_copy->Draw("sameE");
   Double_t xAxis30[4] = {40, 65, 90, 115}; 
   
   TH1D *MT2_susy = new TH1D("MT2_susy","",3, xAxis30);
   ...
   TLatex *   tex = new TLatex(0.4647651,0.8203309,"0 jets");
tex->SetNDC();
...
tex->SetNDC();
   ...
   TH1F *MT2__7 = new TH1F("MT2__7","",3,40,115);
   MT2__7->SetMinimum(0.006210434);
   MT2__7->SetMaximum(1041.938);
   MT2__7->SetDirectory(0);
   MT2__7->SetStats(0);
   MT2__7->SetLineWidth(2);
   MT2__7->GetXaxis()->SetTitle("M_{T2}");
   MT2__7->GetXaxis()->SetNdivisions(505);
   MT2__7->GetXaxis()->SetLabelFont(42);
   MT2__7->GetXaxis()->SetLabelSize(0.05);
   MT2__7->GetXaxis()->SetTitleSize(0.05);
   MT2__7->GetXaxis()->SetTitleOffset(1.1);
   MT2__7->GetXaxis()->SetTitleFont(42);
   MT2__7->GetYaxis()->SetTitle("Events");
   MT2__7->GetYaxis()->SetNdivisions(505);
   MT2__7->GetYaxis()->SetLabelFont(42);
   MT2__7->GetYaxis()->SetLabelSize(0.05);
   MT2__7->GetYaxis()->SetTitleSize(0.05);
   MT2__7->GetYaxis()->SetTitleOffset(1.3);
   MT2__7->GetYaxis()->SetTitleFont(42);
   MT2__7->GetZaxis()->SetLabelFont(42);
   MT2__7->GetZaxis()->SetLabelSize(0.035);
   MT2__7->GetZaxis()->SetTitleSize(0.035);
   MT2__7->GetZaxis()->SetTitleFont(42);
   MT2__7->Draw("sameaxis");
   
   TLegend *leg = new TLegend(0.7097315,0.6384436,0.909396,0.920147,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
...
// ------------>Primitives in pad: MT2_ratio_plotpad_1
   MT2_ratio_plotpad_1 = new TPad("MT2_ratio_plotpad_1", "newpad",0.4412752,0.7422222,0.5738255,0.8688889);
...
// ------------>Primitives in pad: MT2_ratio_ratiopad
   ...
   MT2_ratio_ratiopad->SetFrameBorderMode(0);
   MT2_ratio_ratiopad->SetFrameBorderSize(0);
   Double_t xAxis31[4] = {40, 65, 90, 115}; 
   
   TH1D *h1_copy = new TH1D("h1_copy","",3, xAxis31);
   h1_copy->SetBinContent(1,1);
   h1_copy->SetBinContent(2,1);
   h1_copy->SetBinContent(3,1);
   h1_copy->SetBinError(1,0.1958698);
   h1_copy->SetBinError(2,0.532619);
   h1_copy->SetBinError(3,0.3472921);
   h1_copy->SetMinimum(0);
   h1_copy->SetMaximum(2);
   h1_copy->SetEntries(20.33164);
   h1_copy->SetStats(0);
   ...
   h1_copy->Draw("E2");
   Double_t xAxis32[4] = {40, 65, 90, 115}; 
   
   TH1D *h2_copy__8 = new TH1D("h2_copy__8","",3, xAxis32);
   h2_copy__8->SetBinContent(1,0.9604432);
   h2_copy__8->SetBinContent(2,0.700984);
   h2_copy__8->SetBinContent(3,1.138215);
   h2_copy__8->SetBinError(1,0.1624724);
   h2_copy__8->SetBinError(2,0.4387967);
   h2_copy__8->SetBinError(3,1.172034);
   h2_copy__8->SetMinimum(0.4);
   h2_copy__8->SetMaximum(3);
   h2_copy__8->SetEntries(4.921504);
   h2_copy__8->SetDirectory(0);
   h2_copy__8->SetStats(0);

   ci = TColor::GetColor("#ff0000");
   h2_copy__8->SetFillColor(ci);
   h2_copy__8->SetLineWidth(2);
   h2_copy__8->SetMarkerStyle(20);
   h2_copy__8->GetXaxis()->SetNdivisions(505);
   h2_copy__8->GetXaxis()->SetLabelFont(42);
   h2_copy__8->GetXaxis()->SetLabelSize(0.07);
   h2_copy__8->GetXaxis()->SetTitleSize(0.07);
   h2_copy__8->GetXaxis()->SetTitleOffset(1.1);
   h2_copy__8->GetXaxis()->SetTitleFont(42);
   h2_copy__8->GetYaxis()->SetNdivisions(505);
   h2_copy__8->GetYaxis()->SetLabelFont(42);
   h2_copy__8->GetYaxis()->SetLabelSize(0.07);
   h2_copy__8->GetYaxis()->SetTitleSize(0.07);
   h2_copy__8->GetYaxis()->SetTitleOffset(1.3);
   h2_copy__8->GetYaxis()->SetTitleFont(42);
   h2_copy__8->GetZaxis()->SetLabelFont(42);
   h2_copy__8->GetZaxis()->SetLabelSize(0.035);
   h2_copy__8->GetZaxis()->SetTitleSize(0.035);
   h2_copy__8->GetZaxis()->SetTitleFont(42);
   h2_copy__8->Draw("Esame");
   TLine *line = new TLine(40,1,115,1);
   line->SetLineStyle(7);
   line->SetLineWidth(2);
   line->Draw();
   Double_t xAxis33[4] = {40, 65, 90, 115}; 
   
   TH1D *h1_copy__9 = new TH1D("h1_copy__9","",3, xAxis33);
   h1_copy__9->SetBinContent(1,1);
   h1_copy__9->SetBinContent(2,1);
   h1_copy__9->SetBinContent(3,1);
   h1_copy__9->SetBinError(1,0.1958698);
   h1_copy__9->SetBinError(2,0.532619);
   h1_copy__9->SetBinError(3,0.3472921);
   h1_copy__9->SetMinimum(0);
   h1_copy__9->SetMaximum(2);
   h1_copy__9->SetEntries(20.33164);
   ...
   h1_copy__9->GetXaxis()->SetTitle("M_{T2}");
   h1_copy__9->GetXaxis()->SetNdivisions(505);
